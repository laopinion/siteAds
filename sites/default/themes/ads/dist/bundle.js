...
(0, _jquery2.default)(function () {
  ...
  var orden = new _ordenPauta2.default();
  ...
  _createClass(Home, [{
    ...
    value: function limpiar(indexClick) {
      ...
      (0, _jquery2.default)('#home .right .deviceDesktop div').each(function (index, element) {
        ...
        if (index === indexClick) {
          ...
          (0, _jquery2.default)('#home .right .info #nameBanner').html('' + name.name);
          (0, _jquery2.default)('#home .right .info #infoBanner').html('' + name.description);
        } else {
    ...
    value: function clickLanding() {
      ...
      (0, _jquery2.default)('#home .left .landing').click(function () {
        ...
        (0, _jquery2.default)('#home .right .info #nameBanner').html(name);
        (0, _jquery2.default)('#home .right .info #infoBanner').html('');
    ...
    value: function encontrarName() {
      ...
      (0, _jquery2.default)('#home .left #tipoBanner #listBannersDesktop li').each(function (index, element) {
        if ((0, _jquery2.default)(this).find('.flecha').hasClass('active')) {
          id = (0, _jquery2.default)(this).find('strong').data('index');
        }
      });
